          ...
          <form action="/subscription.php" method="post">
            ...
            <div class="form-body">
              <dl class="form-group">
                ...
                <dd>
                  <textarea name="メッセージ" id="message" rows="5" placeholder="不明な点がございましたら、入力ください"></textarea>
                </dd>
              </dl>
